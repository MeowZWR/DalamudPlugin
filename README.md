...
|--------|----|:------:|:------:|:------:|----|
|[Penumbra](https://github.com/xivdev/Penumbra)|运行时mod加载和管理器|1.1.0.2|CN6.5*|√|国服适配|
|[Glamourer](https://github.com/Ottermandias/Glamourer)|改变和保存玩家外观|1.2.3.1|CN6.5*|√|国服适配|
...
|[Brio](https://github.com/AsgardXIV/Brio)|在集体动作模式中控制参与的角色|0.3.1.6|CN6.55|√|国服适配|
